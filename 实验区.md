    ...
    <style>
        * {
        ...
        .slider-container {
            ...
            background: #fff;
            margin-bottom: 20px; /* Add some space between sliders */
        }
        .slides {
            display: flex;
...
<body>
    <div class="content">
        <div class="slider-container">
            <div class="slides">
                <div class="slide">
                    <img src="https://usst-lilab.github.io/images/实验区/xiaoru.jpg" alt="Image 5">
                </div>
                <div class="slide">
                    <img src="https://usst-lilab.github.io/images/实验区/xiaoru2.jpg" alt="Image 6">
                </div>
            </div>
            <div class="navigation">
                <button id="prev">&#10094;</button>
