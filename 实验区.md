...
<html lang="en">
        ...
        <center>    
            <video id="myVideo" width="400" height="300" controls>
                <source src="/video/uav.mp4" type="video/mp4">
    ...
    document.getElementById('video').addEventListener('play', incrementPlayCount);

    // Get the play count when the page loads
    window.onload = getPlayCount;
  </script>
        </body>
        </html>
